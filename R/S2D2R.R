...
#' @description \code{S2D2R} is used to do dimension reduction via distance covariance by projecting X and Y into subspaces \eqn{W_1,} and \eqn{W_2}, respectively.
